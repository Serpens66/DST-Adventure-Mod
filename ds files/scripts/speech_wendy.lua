return {
	...
	DESCRIBE =
	{
        ...
        FLOTSAM = "The bones of a boat.",

        SUNKEN_BOAT = {
            GENERIC = "Another voyage comes to an end.",
            ABANDONED = "Alas; I am alone again.",
        },
        SUNKEN_BOAT_BURNT = "This boat has departed.",
   		SUNKEN_BOAT_TRINKET_1 = "Maybe I can find my way to someplace better...", --sextant
		SUNKEN_BOAT_TRINKET_2 = "Childhood memories.", --toy boat
		SUNKEN_BOAT_TRINKET_3 = "Another light extinguished.", --candle
		SUNKEN_BOAT_TRINKET_4 = "Looks kinda sciencey.", --sea worther
		SUNKEN_BOAT_TRINKET_5 = "It's a bit beat up.", --boot
	},
