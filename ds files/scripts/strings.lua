...
---------------------- Capy DLC Strings------------------
    ...
    RECIPE_DESC=
    {
        ...
        SHIPWRECKED_ENTRANCE = "Teleport south for the winter.",
...
STRINGS.UI =
{
    ...
    BUGREPORTSCREEN = {
        ...
        SUBMIT_TEXT = "This will record the performance of your game for %d seconds, and then upload a report and your savegame to Klei. Continue?",
...
STRINGS.LUCY =
{
    equipped=
    {
        ...
        "Nice day for a walk!",
        "We make a good team!",
        "I think there's sand permanently embedded in my handle.",
