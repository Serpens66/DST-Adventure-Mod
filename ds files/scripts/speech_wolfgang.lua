return {
	...
	DESCRIBE =
	{
        ...
        FLOTSAM = "Little tree bits playing in the water.",
        SUNKEN_BOAT = {
            GENERIC = "Pretty birdie come from sea!",
            ABANDONED = "Where little birdie go?",
        },
        SUNKEN_BOAT_BURNT = "Boat was no match for match!",
   		SUNKEN_BOAT_TRINKET_1 = "How do I use?", --sextant
		SUNKEN_BOAT_TRINKET_2 = "So tiny!", --toy boat
		SUNKEN_BOAT_TRINKET_3 = "Not so bright.", --candle
		SUNKEN_BOAT_TRINKET_4 = "What is this?", --sea worther
		SUNKEN_BOAT_TRINKET_5 = "Squishy.", --boot
	},
