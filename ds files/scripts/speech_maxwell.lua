return {
	...
	DESCRIBE =
	{
        ...
        FLOTSAM = "Someone has made a mess of the ocean.",
        SUNKEN_BOAT = {
            GENERIC = "This bird's vessel is clearly not seaworthy.",
            ABANDONED = "I'm not sad to see that bird go...",
        },
        SUNKEN_BOAT_BURNT = "Good riddance.",
   		SUNKEN_BOAT_TRINKET_1 = "This could come in handy.", --sextant
		SUNKEN_BOAT_TRINKET_2 = "This boat might actually float.", --toy boat
		SUNKEN_BOAT_TRINKET_3 = "Waxy.", --candle
		SUNKEN_BOAT_TRINKET_4 = "A cleverly assembled sea worther.", --sea worther
		SUNKEN_BOAT_TRINKET_5 = "A boot.", --boot
