...
function CreateStringsPOTv2(filename, root, tbl_dta, tbl_lkp)
	filename = filename or "data\\DLC0002\\scripts\\languages\\temp_v2.pot"
	root = root or "STRINGS"
...
-- 2. Copy the speech_[character].lua files in DontStarve\data\DLC0002\scripts and paste them into DontStarve\data\scripts
...
-- 5. Enter "..\..\tools\LUA\lua.exe createstringspo_dlc_sw.lua" (without quotes) into the cmd line and press return
...
--if BRANCH == "release" then
	...
	CreateStringsPOTv2("..\\DLC0002\\scripts\\languages\\strings.pot", "STRINGS", STRINGS)
