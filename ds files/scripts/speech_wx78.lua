return {
	...
	DESCRIBE =
	{
        ...
        FLOTSAM = "WATER IS THE DESTROYER",
        SUNKEN_BOAT = {
            GENERIC = "ANNOYING BIRD WON'T STOP COMMUNICATING",
            ABANDONED = "SOME FOOLISH HUMAN THOUGHT IT COULD FLOAT",
        },
        SUNKEN_BOAT_BURNT = "HAHAHAHAHA",
   		SUNKEN_BOAT_TRINKET_1 = "USELESS JUNK FROM A SUNKEN SHIP", --sextant
		SUNKEN_BOAT_TRINKET_2 = "USELESS JUNK FROM A SUNKEN SHIP", --toy boat
		SUNKEN_BOAT_TRINKET_3 = "USELESS JUNK FROM A SUNKEN SHIP", --candle
		SUNKEN_BOAT_TRINKET_4 = "USELESS JUNK FROM A SUNKEN SHIP", --sea worther
		SUNKEN_BOAT_TRINKET_5 = "USELESS JUNK FROM A SUNKEN SHIP", --boot
	},
