...
local SlotDetailsScreen = Class(Screen, function(self, slotnum, shield_img)
    ...
    print("Loading slot details my DLC is RoG = ", self.RoG, "  Capy = ", self.capyDLC)
...
function SlotDetailsScreen:PushCantContinueDialog(index)
	...
	elseif index == CAPY_DLC then
		TheFrontEnd:PushScreen(
			PopupDialogScreen(STRINGS.UI.MAINSCREEN.CANT_LOAD_TITLE, STRINGS.UI.MAINSCREEN.CANT_LOAD_CAPY_DLC.." "..STRINGS.UI.MAINSCREEN.SLOT.." "..self.saveslot..".", menu_items ) )
	end
end
