...
function ModsScreen:RefreshOptions()
	...
	for k = 1, page_total do
		...
		opt.SWcompatible:SetScale(.35,.33,1)
		opt.SWcompatible:SetPosition(144, -21, 0)
		...
		opt.RoGcompatible:SetPosition(100, -21, 0)
		...
		opt.DScompatible:SetPosition(56, -21, 0)
...
function ModsScreen:ShowModDetails(idx)
	...
	if modinfo.dont_starve_compatible and modinfo.reign_of_giants_compatible and modinfo.shipwrecked_compatible then
		...
		if modinfo.dont_starve_compatible and not modinfo.reign_of_giants_compatible and not modinfo.shipwrecked_compatible then
			self.detailcompatibility:SetString(STRINGS.UI.MODSSCREEN.COMPATIBILITY_DS_ONLY)
		elseif not modinfo.dont_starve_compatible and modinfo.reign_of_giants_compatible and not modinfo.shipwrecked_compatible then
			self.detailcompatibility:SetString(STRINGS.UI.MODSSCREEN.COMPATIBILITY_ROG_ONLY)
		elseif not modinfo.dont_starve_compatible and not modinfo.reign_of_giants_compatible and modinfo.shipwrecked_compatible then
