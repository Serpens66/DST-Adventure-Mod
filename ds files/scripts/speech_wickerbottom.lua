return 
{
    ...
    DESCRIBE=
    {
        ...
        FLOTSAM = "There appears to be some jetsam amongst that flotsam.",
        SUNKEN_BOAT = {
            GENERIC = "A marooned psittacine with a lugubrious look in his eye.",
            ABANDONED = "This vessel has capsized and is no longer seaworthy.",
        },
        SUNKEN_BOAT_BURNT = "It has become a carbonaceous craft.",
        SUNKEN_BOAT_TRINKET_1 = "Measures the angle between two visible objects.", --sextant
        SUNKEN_BOAT_TRINKET_2 = "A crude approximation of a sailboat.", --toy boat
        SUNKEN_BOAT_TRINKET_3 = "It's a candle.", --candle
        SUNKEN_BOAT_TRINKET_4 = "I have no real idea what that is.", --sea worther
        SUNKEN_BOAT_TRINKET_5 = "To wear on one's foot.", --boot
   },
