return {
	...
	DESCRIBE =
	{
		...
		BOOK_BIRDS = "I already know more than I want to about those things.",
        ...
        FLOTSAM = "Aagh I hate to see a piece of wood go to waste.",
        SUNKEN_BOAT = {
            GENERIC = "This fellow's not from these parts.",
            ABANDONED = "This wood smells like the sea.",
        },
        SUNKEN_BOAT_BURNT = "It still has that salty smell!",
   		SUNKEN_BOAT_TRINKET_1 = "Not quite sure how to use this.", --sextant
		SUNKEN_BOAT_TRINKET_2 = "Makes me want a bath.", --toy boat
		SUNKEN_BOAT_TRINKET_3 = "Like a tiny wax tree.", --candle
		SUNKEN_BOAT_TRINKET_4 = "I'm... not sure what that is.", --sea worther
		SUNKEN_BOAT_TRINKET_5 = "Aboot.", --boot
	},
