return {
	...
	DESCRIBE =
	{
		...
		RATATOUILLE = "We will stuff ourself with eggyplants!",
        ...
        FLOTSAM = "It's all broke.",
        SUNKEN_BOAT = 
        {
            GENERIC = "Awwww I wanna play with a boat too!",
            ABANDONED = "Where did our friend go?",
        },

        SUNKEN_BOAT_BURNT = "Will birdie ever return?",

   		SUNKEN_BOAT_TRINKET_1 = "Looks complicated!", --sextant
		SUNKEN_BOAT_TRINKET_2 = "Fun!", --toy boat
		SUNKEN_BOAT_TRINKET_3 = "Doesn't look very useful.", --candle
		SUNKEN_BOAT_TRINKET_4 = "I'm not sure what that is.", --sea worther
		SUNKEN_BOAT_TRINKET_5 = "That's a big boot!", --boot
	},
