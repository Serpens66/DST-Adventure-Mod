...
local function fn()
    ...
    inst.AnimState:SetBank("maxwell_floatinghead")
    inst.AnimState:SetBuild("maxwell_floatinghead")
...
return Prefab("maxwellhead", fn, assets) , 
MakePlacer("maxwellhead_placer", "maxwell_floatinghead", "maxwell_floatinghead", "idle_loop")
